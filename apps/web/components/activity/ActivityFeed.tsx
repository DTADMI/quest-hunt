...
export function ActivityFeed({
    ...
    const [filter, setFilter] = ActivityType.ALL;
    ...
    const handleNewActivity = useCallback((message: any) => {
    ...
    const markAllAsRead = useCallback(() => {
        ...
        setActivities(prev =>
            prev.map(activity =>
                !activity.isRead ? {...activity, isRead: true} : activity
            )
        );
    ...
    useEffect(() => {
        const connect = async () => {
            try {
                ...
                const unsubscribe = webSocketService.subscribe('new_activity', handleNewActivity);
    ...
    const hasUnread = activities.some(activity => !activity.isRead);
